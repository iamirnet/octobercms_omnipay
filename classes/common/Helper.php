...
class Helper
{
    ...
    public static function getGatewayShortName($className)
    {
        ...
        if (0 === strpos($className, 'iAmirNet\Omnipay\Classes\\')) {
     ...
     *      Stripe              => \iAmirNet\Omnipay\Classes\Stripe\Gateway
     *      PayPal\Express      => \iAmirNet\Omnipay\Classes\PayPal\ExpressGateway
     *      PayPal_Express      => \iAmirNet\Omnipay\Classes\PayPal\ExpressGateway
     *
    ...
    public static function getGatewayClassName($shortName)
    {
        ...
        return '\\iAmirNet\Omnipay\Classes\\'.$shortName.'Gateway';
    }
}
